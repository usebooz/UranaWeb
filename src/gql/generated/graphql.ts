...
export type GetLeagueSquadsQuery = { __typename?: 'Query', fantasyQueries: { __typename?: 'FantasyQueries', rating: { __typename?: 'FantasyRatingQueries', squads?: { __typename?: 'FantasySquadRatingPage', list: Array<{ __typename?: 'FantasySquadRating', scoreInfo: { __typename?: 'FantasyScoreInfo', place: number, score: number, totalPlaces: number, averageScore?: number | null, placeDiff: number, placeAfterTour: number, pointsAfterTour: number, placeAfterTourDiff: number }, squad: { __typename?: 'FantasySquad', id: string, name: string, user: { __typename?: 'user', id: string, nick: string }, benefit: Array<{ __typename?: 'FantasyBenefit', benefitType: FantasyBenefitType, isApply: boolean, isActive: boolean }>, seasonScoreInfo?: { __typename?: 'FantasyScoreInfo', score: number, place: number, totalPlaces: number } | null } }> } | null } } };

export type GetLeagueSquadsWithCurrentTourInfoQueryVariables = Exact<{
  leagueId: Scalars['ID']['input'];
  entityType: FantasyRatingEntityType;
  entityId: Scalars['ID']['input'];
}>;
